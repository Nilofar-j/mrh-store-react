...
const NonAnimeFigures = () => {
    ...
    const resData = data?.data?.non_anime_figures ? Object.values(data.data.non_anime_figures) : [];
        ...
        <section className="special-section w-full py-5">
            ...
            <div className='container px-4 flex flex-col md:flex-row justify-center'>
                <div className="flex justify-center flex-col items-center flex-initial md:w-[25%]">
                    <img src="https://mrh-store.com/static/media/none-anime.ee53661a.png" alt="تخفیفات ویژه مستر اچ" className="w-full max-w-[325px] self-center section-img" />
                    <h2 className='text-[#31eee8] text-center text-[1.2rem] font-bold cursor-pointer'>خرید فیگور شخصیت های غیر انیمه</h2>
                </div>
...
export default NonAnimeFigures;
