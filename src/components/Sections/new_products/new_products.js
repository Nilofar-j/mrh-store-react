...
const NewProducts = () => {
    ...
    const resData = data?.data?.new_products ? Object.values(data.data.new_products) : [];
        ...
        <section className="special-section w-full py-5">
            ...
            <div className='container px-4 flex flex-col md:flex-row justify-center'>
                <div className="flex justify-center flex-col items-center flex-initial md:w-[25%]">
                    <img src="https://mrh-store.com/static/media/newest.e8c14dd3.webp" alt="تخفیفات ویژه مستر اچ" className="w-full max-w-[325px] self-center section-img" />
                </div>
